    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("registrar")!=null) {
            try {
                ...
                cl.setNombreServicio(request.getParameter("nombres"));          
                cl.setCosto(Float.parseFloat(request.getParameter("costos")));
                new modelodao.DaoServicio().setRegistrar(cl);
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(null,ex.getNextException());
            }
        }else if(request.getParameter("borrar")!=null){
            try {
                new  modelodao.DaoServicio().eliminar(new  modelodao.DaoServicio().getServicios(request.getParameter("borrar")));
            } catch (SQLException ex){
                ...
                servicio cl = new servicio();
                cl.setId_servicio(Integer.parseInt(request.getParameter("id")));
                cl.setNombreServicio(request.getParameter("nombres"));
                
            try {
                    new modelodao.DaoServicio().setModificar(cl);
            ...
            try {
                DaoServicio auto= new DaoServicio();
                servicio modifi= auto.getServicios(request.getParameter("btneditar"));
